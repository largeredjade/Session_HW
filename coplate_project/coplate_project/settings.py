...
SECRET_KEY = "django-insecure-9dheb8o)0p$01%v$=d7(-^3ifcyhy7+nhockkholj^(w+p@#i*"
...
ACCOUNT_LOGOUT_ON_GET = True #바로 로그아웃됨

ACCOUNT_USERNAME_REQUIRED = FalseACCOUNT_EMAIL_REQUIRED = True
